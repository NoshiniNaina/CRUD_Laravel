...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header text-center bg-success">{{ __('Add Category') }}
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{url ('category-post')}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('category_name') is-invalid @enderror" value="{{ old('category_name') }}" id="category_name" name="category_name"
